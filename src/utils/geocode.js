...
const geocodeLocation = (latitude, longitude, callback) => {
    const url = `https://api.mapbox.com/geocoding/v5/mapbox.places/${encodeURIComponent(longitude)},${encodeURIComponent(latitude)}.json?access_token=pk.eyJ1IjoiaGF5YTExMSIsImEiOiJjazRoZXgya3YxNW51M25vMmJnOWlrcmo3In0.Fs5cVFjT6TOUwdlhAZyWaA&limit=1`
